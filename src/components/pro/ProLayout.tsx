...
import { Bell, CalendarCheck, LayoutGrid, Monitor, Users2 } from "lucide-react";

const NAV = [
  { to: "/pro", label: "Hoje", icon: CalendarCheck, end: true },
  { to: "/pro/escala", label: "Escala", icon: CalendarCheck, end: false, hidden: true },
  { to: "/pro/comunidade", label: "Comunidade", icon: Users2, end: false },
...
export default function ProLayout() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-20 bg-[#1E1E2E] text-white px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] font-dm text-white/60 leading-tight">EVO Club · treinador</p>
          </div>
          <Link to="/pro/notificacoes" className="ml-auto relative p-2 rounded-lg hover:bg-white/10" aria-label="Notificações">
            <Bell size={20} />
            {unread > 0 && (
      ...
      <div className="fixed bottom-0 left-0 right-0 z-20 border-t border-border bg-card">
        <nav className="flex">
